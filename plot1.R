...
##
##  Have total emissions from PM decreased in the United States from 1999 to
##  2008? Using the base plotting system, make a plot showing the total PM 
...
##
    ...
    ##
    meltNEI <- melt(NEI, id.vars=c("year"), measure.vars=c("emissions"))
    ...
    ##      $ emissions: num  7332967 5635780 5454703 3464206
    ##
...
##
    ...
    plot(tidyNEI$emissions ~ tidyNEI$year,
         main=expression("Total " * PM[2.5] * " Emissions by Year Across the United States"),
